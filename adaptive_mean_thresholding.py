...
input_path = Path("data/pngs/heqpngs/result29.png")
...
cv2.imwrite(os.path.join("data/pngs/","tozero_mask.png"),thTOZERO)

#img = cv2.medianBlur(img,5)

ret,th = cv2.threshold(img,127,255,cv2.THRESH_BINARY)
print(ret)
cv2.imwrite(os.path.join("data/pngs/","adaptive_mask.png"),th)
...
cv2.imwrite(os.path.join("data/pngs/","adaptivemean_mask.png"),thmean)

#Adaptive Gaussian Thresholding
thgaussian = cv2.adaptiveThreshold(img,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,\
     			cv2.THRESH_BINARY,11,2)

cv2.imwrite(os.path.join("data/pngs/","adaptivegaussian_mask.png"),thgaussian)
...
cv2.imwrite(os.path.join("data/pngs/","otsu_mask.png"),th1)
...
cv2.imwrite(os.path.join("data/pngs/","otsugaussian_mask.png"),th2)
